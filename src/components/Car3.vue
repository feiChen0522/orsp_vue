      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8 hidden-xs hidden-sm img01 d">
          <ul>
            ...
            <li>2.填写核对订单信息</li>
            <li class="cur2">3.成功提交订单</li>
          </ul>
        </div>
      </div>
      <div class="col-md-12 ee">
        <div class="col-md-12 success_hd">
          <span>订单提交成功</span>
        </div>
        <div class="success_bd">
          <p><span></span>订单提交成功，我们将及时为您处理</p>
          <p class="message"><strong>完成支付后，你可以</strong> <a href="order.html" class="a01">查看订单状态</a> <a
            href="../index.html" a01>继续购物</a> <a href="" a01>问题反馈</a></p>
        </div>
      </div>
    </div>
  </div>
...
<style scoped>
  ...
  .img01 {
    width: 656px;
    height: 32px;
    background: url("../assets/images/flow_bg.png") 0px -64px;
